  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    emailjs.send(SERVICE_ID, TEMPLATE_ID, templateParams, PUBLIC_KEY)
      .then((result) => {
        ...
        setLoading(false);
        setStatus('success');
        setFormData({ name: '', email: '', projectType: 'stage', message: '' });
        alert("Message envoyé avec succès ! Je vous réponds très rapidement.");
      }, (error) => {
    ...
    <div className="bg-gray-50 min-h-screen py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Discutons de votre projet</h1>
          <p className="text-xl text-gray-600">À la recherche d'une opportunité ou d'un développeur pour votre équipe ?</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 h-fit">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div><p className="text-sm text-gray-500">Téléphone</p><p className="font-semibold text-gray-900">06 46 52 53 43</p></div>
              </div>
              <div className="flex items-center space-x-4">
                <div className="bg-indigo-100 p-3 rounded-full text-indigo-600"><Mail size={24} /></div>
                <div><p className="text-sm text-gray-500">Email</p><p className="font-semibold text-gray-900">clementgosse83@gmail.com</p></div>
              </div>
              <div className="flex items-center space-x-4">
                <div className="bg-indigo-100 p-3 rounded-full text-indigo-600"><MapPin size={24} /></div>
                <div><p className="text-sm text-gray-500">Localisation</p><p className="font-semibold text-gray-900">Côte d'Azur / Sud de la France</p></div>
              </div>
            </div>
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-lg p-8">
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Objet de la demande</label>
                <select 
                  name="projectType"
                ...
                >
                  ...
                  <option value="alternance">Recherche d'Alternance (2026)</option>
                  <option value="freelance">Projet Web / Freelance</option>
              ...
              <div>
                ...
                <textarea 
                  ...
                  className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 outline-none"
                  placeholder="Détaillez votre besoin ou votre offre..."
